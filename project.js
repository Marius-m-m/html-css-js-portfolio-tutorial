const projectDataPage = {
    "float": {
        ...
        gallery: [
            { src: "./assets/Walk.mp4", caption: "Footstep VFX Spawner Triggered by movement. Applies random rotation & scale to meshes to create organic variety." },
            { src: "./assets/Butterfly.mp4", caption: "Interactive Butterfly Swarm Tech: Reactive ambient particles that flee from player input (Hand-Collider). Flight animation is handled via shader based vertex displacement on simple planes to maximize performance while maintaining gameplay interactivity." },
            { src: "./assets/Fireworks.mp4", caption: "Event Driven Firework System Tech: A multi stage system where a leader particle drives secondary emitters. Uses event payloads to pass position and color data from the rocket to the trails and explosion, ensuring synchronized timing and visual consistency without hardcoded values." },
            { src: "./assets/Fish.mp4", caption: "Vertex Animated Fish Swarm Tech: The swimming motion is purely mathematical (Vertex Displacement Shader) eliminating the need for expensive skeletal rigs. Movement is driven by Niagara attraction forces for organic flow." }
        ],
        achievements: [
            { text: "Winner: Varjo Academic Giveaway Campaign", link: "https://www.linkedin.com/feed/update/urn:li:activity:7334126257871175680/" },
            { text: "Winner: Best Student Games Award | Meaningful Game", link: "https://www.studentgamesfestival.com/2025-winners" },
            { text: "Winner: German Multimedia Prize mb21 2025 | Main Award", link: "https://www.mb21.de/wettbewerbsjahr_2025.html?articles=float" },
            { text: "Nominee: XRC25 | Young Talent", link: "https://nextrealitycontest.de/de/nominierte/nominierte-2025/" },
            { text: "Nominee: XRC25 | Community Award", link: "https://nextrealitycontest.de/de/nominierte/nominierte-2025/" },
            { text: "Exhibitor: Gamescom 2025 | Business Area", link: "https://www.games-bavaria.com/gamescom-2025/" },
            { text: "Exhibitor: Gamescom 2025 | Entertainment Area", link: "https://rawtalentbooth.com/" },
            { text: "Exhibitor: GermanDevDays 2025", link: "https://germandevdays.com/exhibitors" },
            { text: "Exhibitor: Play! Con 2025", link: "https://play-con.de/ausstellerinnen-2025-neuulm/" },
            { text: "Exhibitor: Next Reality Festival 2025", link: "https://nextrealityfestival.com/aussteller/float/" },
    ...
    "neo-tokyo": {
        ...
        achievements: [
            { text: "Exhibitor: Game Connect 2025 - Bayern meets Hessen ", link: "https://events.games-bavaria.com/event/%F0%9F%8E%AE-hessen-meets-bayern-game-connect-2025/" },
    ...
    "Mercury": {
        ...
        `,
        gallery: [
            { src: "https://blueprintue.com/render/lrxabwo3/", caption: "Hybrid Physics Reaction System Tech: Applies localized impulses to hit bones and simulates physics below the hips for realistic impact staggering. Includes a custom recovery logic that monitors pose stability in Tick and blends back to kinematic animation once the actor is balanced.", isBlueprint: true },
...
function populateProjectPage(id) {
    ...
    if (!data) {
        document.title = 'Project not found | Marius Maucher Portfolio';
